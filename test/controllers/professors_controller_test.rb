...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { confirmar_senha: @professor.confirmar_senha, email: @professor.email, nome: @professor.nome, senha: @professor.senha }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { confirmar_senha: @professor.confirmar_senha, email: @professor.email, nome: @professor.nome, senha: @professor.senha }
    assert_redirected_to professor_path(assigns(:professor))
  end
