...
class FuncionariosControllerTest < ActionController::TestCase
  ...
  test "should create funcionario" do
    assert_difference('Funcionario.count') do
      post :create, funcionario: { login: @funcionario.login, name: @funcionario.name, password: 'secret', password_confirmation: 'secret' }
    end
  ...
  test "should update funcionario" do
    patch :update, id: @funcionario, funcionario: { login: @funcionario.login, name: @funcionario.name, password: 'secret', password_confirmation: 'secret' }
    assert_redirected_to funcionario_path(assigns(:funcionario))
  end
